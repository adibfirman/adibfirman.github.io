        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1 space-y-8">
              {/* Popular Articles */}
              <div>
                <h3 className="text-lg font-semibold mb-4 text-gray-200">Popular Articles</h3>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {uniqueTags.map((tag) => (
                    <span 
                      key={tag}
                      className="px-2 py-1 bg-gray-800 text-gray-300 text-xs rounded hover:bg-gray-700 cursor-pointer transition-colors"
                    >
                      {tag}
                    </span>
                  ))}
